...
function reverie_setup() {
	...
	register_nav_menus(array('primary_navigation' => __('Primary Navigation', 'reverie'), 'utility_navigation' => __('Utility Navigation', 'reverie')));
}
...
function add_login_logout_link($items, $args) {
	if ($args -> theme_location == 'top') {
		// $items .= '<li>' . '<a class="join-nav" href="http://nba.com"></a>' . '</li>';
		// $items .= '<li>' . '<a class="login-nav" href="http://nba.com"></a>' . '</li>';
	}
	return $items;
}
?>